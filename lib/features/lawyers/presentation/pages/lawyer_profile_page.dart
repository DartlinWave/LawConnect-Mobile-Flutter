...
class LawyerProfilePage extends StatefulWidget {
  final Map<String, dynamic>? lawyerData; // Opcional para cuando venga del backend
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: _lawyer?['imageUrl'] != null 
                        ? DecorationImage(
                            image: NetworkImage(_lawyer!['imageUrl']),
                            fit: BoxFit.cover,
                          )
                        : null,
                  ),
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            _lawyer?['name'] ?? 'Lawyer Name', // TODO: Get from backend
                            style: TextStyle(
                              fontSize: 32,
                          ...
                          Text(
                            _lawyer?['specialty'] ?? 'Specialty', // TODO: Get from backend
                            style: TextStyle(
                              fontSize: 18,
                              color: ColorPalette.greyColor,
                            ),
                ...
                // Description
                Text(
                  _lawyer?['description'] ?? 'Lawyer description will be loaded from backend.', // TODO: Get from backend
                  style: TextStyle(
                    fontSize: 16,
                    height: 1.5,
                    color: ColorPalette.blackColor,
                    ...
                    : Row(
                        children: [
                          if (_reviews.isNotEmpty)
                            Expanded(
                              child: _buildReviewCard(_reviews[0]),
                            ),
                          if (_reviews.length > 1) ...[
                            const SizedBox(width: 12),
                            Expanded(
                              child: _buildReviewCard(_reviews[1]),
                            ),
                          ],
                        ],
                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      review['userRole'] ?? 'Customer', // TODO: Get from backend
                      style: TextStyle(
                        fontSize: 14,
                        color: ColorPalette.greyColor,
                      ),
          ...
          Text(
            review['comment'] ?? 'Review comment will be loaded from backend.', // TODO: Get from backend
            style: TextStyle(
              fontSize: 14,
              height: 1.4,
              color: ColorPalette.blackColor,
